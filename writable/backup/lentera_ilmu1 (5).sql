...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2026 at 05:05 AM
...
INSERT INTO `anggota` (`id_user`, `nama`, `username`, `password`, `email`, `foto`, `created_at`) VALUES
(1, 'mutiara nurul', 'nunu', '1234', 'nunu@gmail.com', '.jpg', '2026-04-28 14:33:20');
...
(108, 6, 1, '2026-04-26', '2026-05-09', 'dikembalikan', 1, 'disetujui'),
(116, 8, 1, '2026-04-28', '2026-05-04', 'dikembalikan', 0, 'tidak'),
(118, 5, 1, '2026-04-28', '2026-05-04', 'dikembalikan', 0, 'tidak'),
(120, 6, 1, '2026-04-28', '2026-05-04', 'menunggu', 0, 'tidak'),
(121, 6, 1, '2026-04-28', '2026-05-04', 'menunggu', 0, 'menunggu');
...
CREATE TABLE `users` (
  ...
  `role` enum('anggota','petugas','admin') DEFAULT 'anggota',
  `foto` varchar(255) DEFAULT NULL,
...
(8, 'iis sadiyah', 'iis.sadiyah7@smk.belajar.id', 'iis', '$2y$10$9GR.Fzu7Cvt9LX4Dcz6LjepZw.p3JK1/KaxIadvcvad9RXDwfGsBS', 'anggota', '1776796709_9223a361d6b62435c1d4.png', 'aktif', '2026-04-21 18:36:42'),
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
...
--
ALTER TABLE `pengembalian`
  MODIFY `id_pengembalian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
